...
class Admin {
	...
	public function create() {
		...
		$sql = "INSERT INTO ". self::$tablename ." (email, firstName, lastName, password) ";
		$sql .= "VALUES('";
		$sql .= $database->escape($this->email) ."', '";
		$sql .= $database->escape(ucfirst($this->firstName)) ."', '";
		$sql .= $database->escape(ucfirst($this->lastName)) ."', '";
	...
	public function update() {
		...
		$sql .= "email =  '";
		$sql .= $database->escape($this->email) ."', firstName = '";
		$sql .= $database->escape(ucfirst($this->firstName)) ."', lastName = '";
		$sql .= $database->escape(ucfirst($this->lastName)) ."', password = '";
		$sql .= $database->escape($this->password) ."' WHERE id = ";
