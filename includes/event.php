...
class Event {
	...
	public function create() {
		...
		$sql = "INSERT INTO ". self::$tablename ." (title, location, description, display_status)";
		$sql .= "VALUES('";
		$sql .= $database->escape(ucfirst($this->title)) ."', '";
		$sql .= $database->escape($this->location) ."', '";
	...
	public function update() {
		...
		$sql .= "title = '";
		$sql .= $database->escape(ucfirst($this->title)) ."', location =  '";
		$sql .= $database->escape($this->location) ."', description = '";
